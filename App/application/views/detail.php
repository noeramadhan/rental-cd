...
<!-- <link rel="apple-touch-icon-precomposed" href='<?=base_url() ;?>assets/logo1.png' />
<meta name="msapplication-TileImage" content='<?=base_url() ;?>assets/logo1.png'/>
 --><!--  --></head>
		...
		<div class="site inner-wrap" id="site-container">
			...
			<header id="masthead" class="site-header" role="banner" itemscope="itemscope" itemtype="http://schema.org/WPHeader">
				<div class="container" id="headboi">
					...
					</div><div class="gmr-search pull-right"><form method="get" class="gmr-searchform searchform" action="http://themovie21.com/"><input type="text" name="s" id="s" placeholder="Search Movie" /><input type="hidden" name="post_type[]" value="post"><input type="hidden" name="post_type[]" value="tv"></form></div>					</div>
					</div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="footer-column col-md-4">
                                            <div id="text-4" class="widget widget_text"><h3 class="widget-title">REN'DY</h3><div class="textwidget">REN'DY adalah sebuah website hiburan yang menyajikan layanan peminjaman film Subtitle Indonesa Secara ONLINE.
                                            Dibuat oleh :
                                        ...
                                        <div class="footer-column col-md-4">
                                            <div id="views-1" class="widget widget_views"><h3 class="widget-title">Most Rent Film</h3><ul>
                                                <li><a href="http://themovie21.com/avengers-infinity-war-2018/"  title="Avengers: Infinity War (2018)">Avengers: Infinity War (2018)</a> - 9,307 views</li><li><a href="http://themovie21.com/jurassic-world-fallen-kingdom-2018/"  title="Jurassic World: Fallen Kingdom (2018)">Jurassic World: Fallen Kingdom (2018)</a> - 7,984 views</li><li><a href="http://themovie21.com/dilan-1990-2018/"  title="Dilan 1990 (2018)">Dilan 1990 (2018)</a> - 3,992 views</li><li><a href="http://themovie21.com/tomb-raider-2018/"  title="Tomb Raider (2018)">Tomb Raider (2018)</a> - 3,751 views</li><li><a href="http://themovie21.com/dragon-hunter-2017/"  title="Dragon Hunter (2017)">Dragon Hunter (2017)</a> - 3,245 views</li></ul>
                                            </div>                      </div>
                                            <div class="footer-column col-md-4">
                                                <div id="media_image-3" class="widget widget_media_image"><h3 class="widget-title">Rental Film Online</h3><a href="http://themovie21.com"><img src='<?=base_url() ;?>assets/logo1.png' alt="Ren'dy" title="Ren'dy" style="margin-top: -50px; width:260px; height:200px"/>
</a></div>                      </div>
                                            </div>  
                                        </div>  
                                    </div>
															...
															<footer id="colophon" class="text-center site-footer" role="contentinfo" >
																<div class="container">
																	<div class="site-info">
																		<a href="http://themovie21.com">Rental Film Subtitle Indonesia Online</a>			</div><!-- .site-info -->
																	</div><!-- .container -->
																</footer><!-- #colophon -->
