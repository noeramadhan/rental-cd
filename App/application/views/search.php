			...
			<div class="clearfix gmr-headwrapper">
				<div class="gmr-logo">
					<a href="http://themovie21.com/" class="custom-logo-link" itemprop="url" title="TheMovie21">
						<img src='<?=base_url() ;?>assets/logo1.png' alt="Ren'dy" title="Ren'dy" style="max-height: 200px!important"/>

					</a>
				</div>
				<div class="gmr-search pull-right"><form method="get" class="gmr-searchform searchform" action="http://themovie21.com/"><input type="text" name="s" id="s" placeholder="Search Movie" /><input type="hidden" name="post_type[]" value="post"><input type="hidden" name="post_type[]" value="tv"></form></div>					</div>
			</div>
